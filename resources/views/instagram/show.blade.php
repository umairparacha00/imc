@extends ('layouts.app')
@section('title')
	<title>Profile Links - Amlaen</title>
@endsection
@section('style')
	<style type="text/css">
				...
				<div class="row">
					<div class="col-md-6 col-sm-12">
						<div class="row">
							<div class="col-sm-12">
								<ul>
									<li>Click button below and open Instagram</li>
							...
							<div class="col-sm-12">
								@if($errors->any())
									...
									@endforeach
								@endif
								<form action="{{ route('instagram.profiles.store', $link->id) }}" method="POST"
									...
									<div class="d-flex justify-content-between mb-3">
										<div>
											<a class="btn btn-primary" href="{{ $link->link }}" target="_blank">Instagram
												Profile
											</a>
										</div>
										<div>
