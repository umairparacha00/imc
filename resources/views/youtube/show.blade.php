				...
				<div class="row">
					<div class="col-md-6 col-sm-12">
						<div class="row">
							<div class="col-sm-12">
								<ul>
									<li>Click button below and open youtube</li>
									<li>Click Subscribe button and confirm</li>
							...
							<div class="col-sm-12">
								@if($errors->any())
									...
									@endforeach
								@endif
								<form action="{{ route('youtube.channels.store', $link->id) }}" method="POST"
									...
									<div class="d-flex justify-content-between mb-3">
										<div>
											<a class="btn btn-primary" href="{{ $link->link }}" target="_blank">Youtube
												Channel
											</a>
										</div>
										<div>
