			...
			<div class="d-flex justify-content-between align-items-center pb-2">
				...
				<div>
					<div class="d-flex justify-content-around align-items-center mr-5">
						...
						@endrole
						<a href="{{ route('payment-gateways.index') }}" class="back mr-4">
							<i class="fal fa-backward"></i>
						</a>
						<a href="{{ route('payment-gateways.edit', $gateway->id) }}" class="edit">
						...
						<div class="col-lg-8">
							<div class="profile-inner column-data">
								<div class="badge
									@if ($gateway->status === 0)
										badge-warning
										@elseif($gateway->status === 1)
										badge-success
										@elseif($gateway->status === 2)
										badge-danger
										@elseif($gateway->status === 3)
										badge-dark
									@endif
										">
									@if ($gateway->status === 0)
